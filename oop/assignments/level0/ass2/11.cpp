...
/*OUTPUT
Enter two integers, one for feet and one for inches: 12 
1

The numbers you entered are 12 for feet and 1 for inches. 
The total number of inches = 145
The number of centimeters = 368.3*/
